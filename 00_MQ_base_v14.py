"""
00_MQ_base_v14.py
Bug fixed when where user leaves quiz while is not finished,
    The choosableUI was still disabled in the other windows (words, results)
"""
...
class QuizScreen(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.label1 = ctk.CTkLabel(self, text="Welcome to Maori Quiz Game!", font=("Arial", 15))
        self.label1.grid(row=1, column=1, padx=20, pady=20)

        self.label2 = ctk.CTkLabel(self, text="")
        self.label2.grid(row=2, column=1)

        self.scorelabel = ctk.CTkLabel(self, text="Score: 0", font=("Arial", 15, "bold"))
